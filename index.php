    ...
    <body>
        <center>
            ...
            <div id="tables">
                ...
                <a href="https://allegro.pl/auth/oauth/authorize?response_type=code&client_id=cc825xxxdirect_uri=http://localhost/kodyean.php"><button id="login">UZYSKAJ TOKEN DOSTĘPOWY DLA RAFMAR</button></a>
