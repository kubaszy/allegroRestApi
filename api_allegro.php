...
ini_set('max_execution_time', 300); 
    $ProductArray = [
        'rowenta','philips','xblitz','caferomantica','kenwood','hoover','roomba','ilife','yi','karcher','delonghi','mio','krups','Beko','tefal','zelmer','siemens','sandisk','bosch','saeco','inlife','sharp','reinston','navitel','eldom','sage','braun','remington','kingston','huawei','logitech'
    ];
    $offset=1;
    $limit=100;
    for ($i=0;$i<4;$i++) {
