...
ini_set('max_execution_time', 300); 
    $ProductArray = [
        '4tech','acer','adata','asus','Audio-Technica','bang&olufsen','benq','blow','canon','compaq','creative','dell','devia','d-link','epson','esperanza','fellowes','forever','gembird','goodram','google','hitachi','honor','hp','huawei','ibox','iiyama','iphone','jabra','jays','kingston','lenovo','lg','logitech','media-tech','mint','modecom','msi','myphone','natec','navitel','netgear','netis','nokia','norton','optoma','panasonic','philips','platinet','pny','qpad','razer','rmore','rockbox','samsung','sandisk','seagate','sharp','shiru','silver','snab','sony','targus','Thrustmaster','tomtom','toshiba','tp-link','transcend','trust','vakoss','xiaoyi','ipad','isk','lamax'
    ];
    $offset=1;
    $limit=100;
    for ($il=0;$il<4;$il++) {
        ...
        if ($offset==1) {
            echo '<table><thead>';
            echo '<tr class="header"><td>Lista ofert NIE WYRÓŻNIONYCH</td><td>Nasza Cena</td><td>Najniższa Cena</td><td>Szukana fraza</td></tr>';
        }
